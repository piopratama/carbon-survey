...
//             const p = feature.properties; // TAMBAH INI

//             layer.bindPopup(
//                 //AdminApp.samplingPopupHTML(p)
//                 window.AdminApp.samplingPopupHTML(p)
//             );

//             layer.unbindTooltip();

//             // TAMBAH INI (inti dari fitur)
//             if (AdminApp.showPointId) {
...
//     AdminApp.togglePointIdVisibility = function (isVisible) {
//         AdminApp.showPointId = isVisible;

//         samplingLayer.clearLayers(); // hapus marker lama
//         loadSamplingPoints(CURRENT_PROJECT_ID); // load ulang
//     };
...
window.AdminApp = (function () {
    ...
    let samplingLayer = L.geoJSON(null, {
        ...
        onEachFeature: (feature, layer) => {
            ...
            if (window.AdminApp.showPointId) {
                layer.bindTooltip(`${p.id}`, {
                    permanent: true,
                    direction: "top",
    ...
    return {
        showPointId: AdminApp.showPointId,
        samplingLayer,
        loadSamplingPoints,
        generateSampling,
        previewSampling,
